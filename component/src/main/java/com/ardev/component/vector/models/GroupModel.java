...
public class GroupModel {
    ...
    public GroupModel() {
        rotation = Default.GROUP_ROTATION;
        pivotX = Default.GROUP_PIVOT_X;
        pivotY = Default.GROUP_PIVOT_Y;
        scaleX = Default.GROUP_SCALE_X;
        scaleY = Default.GROUP_SCALE_Y;
        translateX = Default.GROUP_TRANSLATE_X;
        translateY = Default.GROUP_TRANSLATE_Y;
