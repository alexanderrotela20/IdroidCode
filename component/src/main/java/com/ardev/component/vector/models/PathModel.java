...
import com.ardev.component.vector.*;
...
public class PathModel {
    ...
    public PathModel() {
        fillAlpha = Default.PATH_FILL_ALPHA;
        fillColor = Default.PATH_FILL_COLOR;
        fillType = Default.PATH_FILL_TYPE;
        trimPathStart = Default.PATH_TRIM_PATH_START;
        trimPathEnd = Default.PATH_TRIM_PATH_END;
        trimPathOffset = Default.PATH_TRIM_PATH_OFFSET;
        strokeAlpha = Default.PATH_STROKE_ALPHA;
        strokeColor = Default.PATH_STROKE_COLOR;
        strokeLineCap = Default.PATH_STROKE_LINE_CAP;
        strokeLineJoin = Default.PATH_STROKE_LINE_JOIN;
        strokeMiterLimit = Default.PATH_STROKE_MITER_LIMIT;
        strokeWidth = Default.PATH_STROKE_WIDTH;
        strokeRatio = Default.PATH_STROKE_RATIO;
