...
private Context context;
	...
	public BreadcrumbsAdapter(BreadcrumbsView parent, ArrayList<IBreadcrumbItem> items) {
        ...
        PADDING = parent.getResources().getDimensionPixelSize(R.dimen.dropdown_start_padding_increase);
	}
	...
	public ItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		...
		} else if (viewType == R.layout.bcv_item_text/*R.layout.breadcrumbs_view_item_arrow*/) {
