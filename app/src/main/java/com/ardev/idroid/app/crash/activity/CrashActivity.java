...
public final class CrashActivity {
	...
	private static final String EXTRA_CONFIG = "com.ardev.idroid.EXTRA_CONFIG";
	private static final String EXTRA_STACK_TRACE = "com.ardev.idroid.EXTRA_STACK_TRACE";
	private static final String EXTRA_ACTIVITY_LOG = "com.ardev.idroid.EXTRA_ACTIVITY_LOG";
	//General constants
	private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.ardev.idroid.ERROR";
	private static final String INTENT_ACTION_RESTART_ACTIVITY = "com.ardev.idroid.RESTART";
	private static final String CRASH_HANDLER_PACKAGE_NAME = "com.ardev.idroid.";
	private static final String DEFAULT_HANDLER_PACKAGE_NAME = "com.android.internal.os";
	private static final int MAX_STACK_TRACE_SIZE = 131071; //128 KB - 1
	private static final int MAX_ACTIVITIES_IN_LOG = 50;
	//Shared preferences
	private static final String SHARED_PREFERENCES_FILE = "com.ardev.crash_preferences";
				...
				if (oldHandler != null && oldHandler.getClass().getName().startsWith(CRASH_HANDLER_PACKAGE_NAME)) {
					...
					application.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
						...
						public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
							...
							if (config.isTrackActivities()) {
								activityLog.add(dateFormat.format(new Date()) + ": "
										+ activity.getClass().getSimpleName() + " creado\n");
							}
						}
						...
						public void onActivityResumed(Activity activity) {
							if (config.isTrackActivities()) {
								activityLog.add(dateFormat.format(new Date()) + ": "
										+ activity.getClass().getSimpleName() + " resumido\n");
							}
						}
						...
						public void onActivityPaused(Activity activity) {
							if (config.isTrackActivities()) {
								activityLog.add(dateFormat.format(new Date()) + ": "
										+ activity.getClass().getSimpleName() + " pausado\n");
							}
						}
						...
						public void onActivityDestroyed(Activity activity) {
							if (config.isTrackActivities()) {
								activityLog.add(dateFormat.format(new Date()) + ": "
										+ activity.getClass().getSimpleName() + " destruido\n");
							}
						}
					});
				}
	...
	public static String getAllErrorDetailsFromIntent(@NonNull Context context, @NonNull Intent intent) {
		...
		String errorDetails = "";
		errorDetails += "Version: " + versionName + " \n";
		if (buildDateAsString != null) {
			errorDetails += "Fecha de instalación: " + buildDateAsString + " \n";
		}
		errorDetails += "Fecha actual: " + dateFormat.format(currentDate) + " \n";
		errorDetails += "Dispositivo: " + getDeviceModelName() + " \n \n";
