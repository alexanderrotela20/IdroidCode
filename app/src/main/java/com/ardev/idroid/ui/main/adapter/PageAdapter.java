...
import com.ardev.idroid.ui.main.fragment.editor.EmptyCodeEditorFragment;
import com.ardev.idroid.ui.main.fragment.preview.ImageFragment;
import com.ardev.idroid.ui.main.fragment.editor.GradleCodeEditorFragment;
import com.ardev.idroid.ui.main.fragment.editor.KotlinCodeEditorFragment;
import com.ardev.idroid.ui.main.fragment.editor.JsonCodeEditorFragment;
import com.ardev.idroid.ui.main.fragment.editor.JavaCodeEditorFragment;
import com.ardev.idroid.ui.main.fragment.editor.XmlCodeEditorFragment;
...
public class PageAdapter extends FragmentStateAdapter {
    ...
    Fragment fragment = null;
     if(getFileName(position).endsWith(".xml")) {
    	 ...
    	 fragment =	new XmlCodeEditorFragment(getFilePath(position));
     	}
      
       } else if(getFileName(position).endsWith(".java")) {
        fragment =	new JavaCodeEditorFragment(getFilePath(position));
       } else if(getFileName(position).endsWith(".json")) {
        fragment =	new JsonCodeEditorFragment(getFilePath(position));
       } else if(getFileName(position).endsWith(".kt")) {
        fragment =	new KotlinCodeEditorFragment(getFilePath(position));
       } else if(getFileName(position).endsWith(".gradle")) {
       fragment =	new GradleCodeEditorFragment(getFilePath(position));
       } else if(isImage(getFilePath(position))) {
       fragment =	new ImageFragment(getFilePath(position));
       } else {
       fragment =	new EmptyCodeEditorFragment(getFilePath(position));
       }
