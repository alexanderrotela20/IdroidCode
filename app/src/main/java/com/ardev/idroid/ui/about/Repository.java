...
import android.content.Context;
	...
	MaterialAboutCard appCard = new MaterialAboutCard.Builder()
             ...
             .addItem(new MaterialAboutTitleItem.Builder()
                ...
                .setOnClickAction(ConvenienceBuilder.createWebViewDialogOnClickAction(context, "Releases", "https://github.com/daniel-stoneuk/material-about-library/releases", true, false))
                .build())
