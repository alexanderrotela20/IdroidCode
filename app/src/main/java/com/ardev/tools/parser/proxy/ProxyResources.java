package com.ardev.tools.parser.proxy;
/**
...
public class ProxyResources {
    ...
    public String getString(String reference) {
        ...
        if (reference.startsWith("@android:string/")) {
            ...
            if (stringMap.containsKey(name)) {
                ...
                debug.logE("string " + reference + " no encontrado");
            }
        }
        return reference;
    }
    ...
    public int getRes(String attr) {
        ...
        debug.logE("Atributo " + attr + "inválido");
        return -1;
    }
    ...
    public int getStyle(String style) {
        ...
        debug.logE("No se pudo encontrar el valor del estilo：" + style);
        return -1;
    }
    ...
    public View findViewById(Activity activity, String id) {
        ...
        debug.logE("Vista no encontrada：" + id);
        return null;
    }
    ...
    public Drawable getDrawable(String reference) {
        ...
        debug.logE("Drawable no encontrado：" + reference);
        return null;
    }
    ...
    public int getColor(String reference) {
        ...
        if (reference.startsWith("@android:color/")) {
          ...
          int id = getSystemResourceId(androidx.appcompat.R.color.class, name);
            if (id != -1) {
                return ctx.getResources().getColor(id);
            }
          
        }
        debug.logE("Color no encontrado：" + reference);
    ...
    public int getSystemResourceId(Class clazz, String name) {
        try {
            ...
            debug.logE("Recurso del sistema no encontrado：" + clazz + " " + name);
        }
        return -1;
    }
}
