...
public class ProxyAttributeSet {
    ...
    private String parseRowAttributeValue(@NonNull String name, String value) {
        ...
        debug.logW(mParser.getLineNumber() + "línea" + mParser.getColumnNumber() + "columna: ninguna propiedad analizada" + name + ", verifique si la propiedad existe (o si el analizador no la manejó correctamente).");
    ...
    private String parseFlag(String name, String value) {
        ...
        for (String f : flags) {
            if (!f.trim().isEmpty()) {
                ...
                debug.logE(value + " Formato erróneo");
            }
        }
    ...
    private String parseUnitString2Px(String unitString) {
        ...
        debug.logE(  unitString + " no es un número de unidad!" + " en Línea: " + mParser.getLineNumber() +  " Columna：" +mParser.getColumnNumber() );
